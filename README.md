...
| 角色 | 价值 | 飞轮 | 商业模式 |
|------|------|------|---------|
| **帮长辈** 🧓 | 老有所依、老有所为、老有所得 | 流入→留住→锁住 | 免费使用，后置授权 |
| **帮家属** 👨‍👩‍👧‍👦 | 远程尽孝、安心无忧、孝心常伴 | 留住→锁住→裂变 | 情感驱动传播 |
| **帮社区** 🏘️ | AI便民、暖心服务、共建美好家园 | 引流→留住→锁住 | 团长QR码，消费收益 |
| **帮商家** 🏪 | 智能引流、轻松长效盈利 | 引流→锁住 | 获客工具锁客裂变 |
| **帮创业** 🚀 | 孝心蓝海、零风险、轻松创业 | 引流→留住→锁住→裂变 | 推广大使多层分润 |

> **核心商业逻辑**: 做一件事，收益叠加。团长/商家/创业者的本职工作 + 平台分润 = 一份时间卖两次。
